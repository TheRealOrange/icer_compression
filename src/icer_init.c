...
void icer_init_decodescheme() {
    ...
    INIT_DECODE_SCHEME(ICER_ENC_BIN_2, 0b00001, 5, 0b00000, 5);
    ...
    INIT_DECODE_SCHEME(ICER_ENC_BIN_3, 0b00011, 5, 0b10010, 5);
    INIT_DECODE_SCHEME(ICER_ENC_BIN_3, 0b00010, 5, 0b1111, 4);
